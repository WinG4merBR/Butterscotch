...
* `--gml-profiler`: Logs which GML scripts are the heaviest in terms of time and executed instructions.
* `--opcode-profiler`: Ranks which GML opcodes were executed the most.
